...
static CommonLog commonLogger(logHandler,"readthread");
#define READTHREAD_LOG(level) COMMON_LOG(commonLogger, level)
...
void ReadPacketsThread::run()
{
    ...
    READTHREAD_LOG(INFO) << "ReadPacketsThread::run..." << std::endl;
